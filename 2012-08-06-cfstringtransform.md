...
它虽然很强大，但是不提提它的可无缝转换（[toll-free bridged](https://developer.apple.com/library/ios/#documentation/CoreFoundation/Conceptual/CFDesignConcepts/Articles/tollFreeBridgedTypes.html)）的表兄弟 CFMutableString，或者更特殊的 CFStringTransform，是不负责任的。
